            ...
            <div class="box-body no-padding">
              ...
              <table id="example1" class="table table-bordered">
                ...
                <tr>
                 ...
                 data-myhrel="{{$re->hrel}}"
                 data-mysib="{{$re->sib}}"
                  data-toggle="modal" data-target="#nonResident">Verify</button></td>
                </tr>
                @endforeach
              </tbody></table>
            </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title text-center" id="myModalLabel">Verify Bonafide Resident?</h4>
      </div>
  
        <form action="{{route('nonresident.destroy','test')}}" method="post" files="true" enctype="multipart/form-data">
                {{csrf_field()}}
                {{method_field('delete')}}
        
      <div class="modal-body">
        <center><p>Are you sure that resident is a bonafide of Barangay Guyong ?</p></center>
